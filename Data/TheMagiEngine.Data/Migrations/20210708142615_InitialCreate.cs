        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LikedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikedMemberships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikedMemberships_AspNetUsers_LikedByUserId",
                        column: x => x.LikedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LikedMemberships_Memberships_MembershipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikedMemberships_LikedByUserId",
                table: "LikedMemberships",
                column: "LikedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LikedMemberships_MembershipId",
                table: "LikedMemberships",
                column: "MembershipId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistBooks_WishlistId",
                table: "WishlistBooks",
                column: "WishlistId");
